...
def lpost(
    ...
    return (
        ...
        + llike(data_wavelet, signal_wavelet, psd_wavelet)
    )
...
param_start = [
    a_true + 10 * delta_a,
    f_true + 5 * delta_f,
    fdot_true - 5 * delta_dotf,
]  # Starting values
true_vals = [a_true, f_true, fdot_true]  # True values

a_chain, f_chain, fdot_chain, lp = MCMC_run_wavelet(
    data_wavelet,
    t,
    psd_wavelet,
    Ntotal,
