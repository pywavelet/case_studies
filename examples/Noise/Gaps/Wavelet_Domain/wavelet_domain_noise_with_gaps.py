...
h_pad_w = w_t * h_t_pad 
h_pad_fft = np.fft.rfft(w_t * h_t_pad) 
...
kwargs_true_psd_matrix = {"title":"True wavelet covariance matrix"}
...
plot_wavelet_grid(cov_matrix_wavelet,
                ...
                freq_scale="linear",
                absolute=False,
                freq_range = [psd_wavelet.freq[1], psd_wavelet.freq[-1]],
                **kwargs_cov_matrix)
...
plot_wavelet_grid(psd_wavelet.data,
                ...
                absolute=False,
                freq_range = [psd_wavelet.freq[1], psd_wavelet.freq[-1]],
                **kwargs_true_psd_matrix)

plot_wavelet_grid(cov_matrix_gap_wavelet,
                time_grid=noise_gap_wavelet.time,
