...
def main(
    ...
    Cov_Matrix = np.zeros(shape=(N // 2 + 1, N // 2 + 1),
                          dtype=complex)  # Matrix will be filled full of complex numbers.
    ...
    if TDI == "TDI1":
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_gap_TDI1.npy", Cov_Matrix_Gated)
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_inv_regularised_TDI1.npy", Cov_Matrix_Gated_Inv_Regularised)
    elif TDI == "TDI2":
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_gap_TDI2.npy", Cov_Matrix_Gated)
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_inv_regularised_TDI2.npy", Cov_Matrix_Gated_Inv_Regularised)
    else:
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_gap_Cornish.npy", Cov_Matrix_Gated)
        np.save(f"{DATA_DIR}/Cov_Matrix_analytical_inv_regularised_Cornish.npy", Cov_Matrix_Gated_Inv_Regularised)
