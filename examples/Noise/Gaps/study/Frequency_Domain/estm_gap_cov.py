...
def main(
    ...
    print("SNR when there are gaps in the frequency domain is", SNR2_gaps_regularised ** 0.5,
    ...
    np.save(f"{DATA_DIR}/Cov_Matrix_estm_inv_regularised_{TDI}.npy", cov_matrix_freq_gap_regularised_inv)
