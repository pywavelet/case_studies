...
plt.tight_layout() 
plt.savefig("matrix_directory/Cov_Matrix_Flat_w_filter.png")


Cov_Matrix = np.load("matrix_directory/Cov_Matrix_Flat_w_filter_gap.npy")
...
plt.tight_layout()
plt.savefig("matrix_directory/Cov_Matrix_Flat_w_filter_gap.png")