...
def main(
    ...
    for i in tqdm(range(0,10000)):
        ...
        noise_wavelet_individual_chunks = [from_time_to_wavelet(item, Nf = Nf)
                                            for item in Chunked_Data]
        
        flattened_vec_no_gap.append(noise_wavelet.data.flatten())
        flattened_vec_gap_seg_0.append(noise_wavelet_individual_chunks[0].data.flatten()) 
        flattened_vec_gap_seg_1.append(noise_wavelet_individual_chunks[-1].data.flatten()) 
